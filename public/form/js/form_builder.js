$(document).ready(function () {
    ...
    function getTextFieldHTML() {
        ...
        var html = '<div class="all_div">' +
            ...
            '<div class="col-md-12"><button type="button" class="btn btn-primary btn-sm remove_bal_field pull-right" data-field="' + field + '">' +
            ...
            '<div class="col-md-12">' +
            '<div class="form-group">' +
            '<input type="text" name="placeholder_' + field + '" data-field="' + field + '" class="form-control form_input_placeholder" placeholder="Placeholder"/>' +
            '</div></div><div class="col-md-12"><div class="form-group">' +
            '<input type="text" name="text_' + field + '" class="form-control form_input_name" placeholder="Name"/></div>' + '</div>';

             // '<div className="form-check m-l-10" style="margin-right: 20px">'+
            // '<label className="form-check-label">'+
            //         '<input className="form-check-input" type="checkbox" data-field="' + field + '">'+
