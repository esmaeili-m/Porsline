(function (c) {
    ...
    i.ext.buttons.print = {
        className: "buttons-print", text: function (a) {
            ...
            var a = b.buttons.exportData(c.extend({decodeEntities: !1}, h.exportOptions)), e = b.buttons.exportInfo(h),
            ...
            g.document.body.innerHTML = "<h4>" + e.title + "</h4><div>" + (e.messageTop || "") + "</div>" + d + "<div>" + (e.messageBottom || "") + "</div>";
